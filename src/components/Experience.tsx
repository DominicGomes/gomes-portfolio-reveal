  ...
  const experiences = [
    {
      ...
      description: "As a junior software engineer for a widely known credit union, I work in C# ASP.NET MVC 5 framework, adept at designing anddeveloping robust and secure web applications.Have intermediate knowledge in leveraging MVC architecture to create efficient server-side solutions.",      
    },
    {
      ...
      {experiences.map((exp, index) => (
        ...
        >
          ...
          <div className={`mt-8 lg:mt-0 lg:w-[48%] ${index % 2 === 0 ? 'lg:mr-12' : 'lg:ml-12'}`}>
            <div className="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-gray-700/50 shadow transition duration-300 ease-in-out hover:scale-[1.02] hover:border-portfolio-accent/60">
              ...
              <p className="text-portfolio-text/80 leading-relaxed text-sm sm:text-base">
                {exp.description}
              </p>
            </div>
          </div>
